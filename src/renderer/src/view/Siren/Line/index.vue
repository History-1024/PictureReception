  ...
  <div class="container">
    ...
    <div v-loading="loading" element-loading-text="正在请求数据中，请稍后……" class="bottom">
      <el-table
        ...
        height="100%"
        max-height="100%"
        :default-sort="{ prop: 'oneLevel', order: 'descending' }"
      >
        ...
        <el-table-column prop="oneLevel" label="一级数量" sortable />
        <el-table-column prop="twoLevel" label="二级数量" sortable />
        <el-table-column prop="threeLevel" label="三级数量" sortable />
        <template #empty>
